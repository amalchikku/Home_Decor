        ...
        <div className="container nx-auto flex flex-col md:flex-row justify-between items-start">
          <div className="w-full md:w-1/3 mb-8 md:mb-0">
            ...
            <p className=" text-gray-400 mt-4">
              ...
              provident tenetur at sequi aspernatur animi ipsam incidunt dicta
              repudiandae delectus velit atque.
            </p>
          </div>
          <div className="w-full md:w-1/5 mb-8 md:mb-0">
            <h3 className="text-white text-lg font-bold mb-4">Company</h3>
            <ul className="flex flex-col gap-2 text-gray-400">
              <a href="About" className="hover:white">
                About
              </a>
              <a href="Contact" className="hover:white">
                Contact US
              </a>
